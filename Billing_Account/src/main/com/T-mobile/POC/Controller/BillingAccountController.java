...
import Service.BillingAccountService;
...
public class BillingAccountController {
    ...
    public ResponseEntity<?> updateBillingAccountInfo(@ModelAttribute BillingAccountVO billingAccountVO) {
        if (billingAccountVO != null && billingAccountVO.getAccountID() != null)
            try {
                billingAccountVO = service.updateBillingAccountInfo(billingAccountVO);
                return new ResponseEntity(billingAccountVO, HttpStatus.OK);
            } catch (Exception e) {
                return new ResponseEntity("Error Occurred while processing!", HttpStatus.BAD_REQUEST);
            }
